...
namespace CastleGrimtol.Project
{
    public class Game : IGame
    {
        ...
        public void Setup()
        {
            ...
            Room CaveRight = new Room("Cave Right", "You decide to go right. It is very dark. You ask Charmander to lead the way with his tail. The pokemon start to smell something. They lead you to a entrance to the left and there seems to be a stack of yummy berries behind a boulder. You let them eat some. Do you want to take one for the road? [Pick up Item or Discard]. Go [Left or Back].");
